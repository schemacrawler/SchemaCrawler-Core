...
public class AbstractTextSupportTest {

  private final AbstractTextSupport support = new AbstractTextSupport() {};
  ...
  public void entities() {
    ...
    final AbstractTextSupport supportWithEntity = new AbstractTextSupport() {};
    ...
    final AbstractTextSupport supportWithView = new AbstractTextSupport() {};
