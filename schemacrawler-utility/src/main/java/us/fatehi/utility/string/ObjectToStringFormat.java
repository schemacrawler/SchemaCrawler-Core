 ...
 *   <li><b>Output format varies</b> — delegates to {@link ObjectToStringFunction}; when Jackson is
 *       present the output is valid JSON, otherwise plain-text collection/map formatting.
