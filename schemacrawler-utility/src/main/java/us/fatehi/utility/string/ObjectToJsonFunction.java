 ...
 * ObjectToStringFunction} if Jackson is not available on the classpath.
 *
 * <p><b>Caveats:</b>
 *
 * <ol>
 ...
 *       {@link ObjectToJsonFormat} instead, which wraps the target object lazily from the outside.
 *   <li><b>Jackson optional</b> — if Jackson is absent from the classpath, silently delegates to
 *       {@link ObjectToStringFunction} so callers always receive a non-null string.
