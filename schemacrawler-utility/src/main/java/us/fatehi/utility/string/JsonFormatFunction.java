...
final class JsonFormatFunction implements Function<Object, String> {
  ...
  private static final ObjectMapper OBJECT_SERIALIZER =
      newSerializingObjectMapper(JsonMapper.builder());

  @Override
  public String apply(final Object object) {
    try {
      return OBJECT_SERIALIZER.writeValueAsString(object);
    } catch (final JacksonException e) {
      return String.valueOf(object);
    }
  }

  private static ObjectMapper newSerializingObjectMapper(
